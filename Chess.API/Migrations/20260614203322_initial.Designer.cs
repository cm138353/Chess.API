...
namespace Chess.API.Migrations
{
    ...
    [Migration("20260614203322_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chess.API.Entities.Chess.GameMove", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("GameMoves", "games");
                });

            modelBuilder.Entity("Chess.API.Entities.Chess.GameState", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chess.API.Entities.Chess.GameMove", b =>
                {
                    b.HasOne("Chess.API.Entities.Chess.GameState", null)
                        .WithMany("Moves")
