...
public class APIModule : AbpModule
{
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(APIModule).Assembly);
        });
    }
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("API");
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        Configure<AbpVirtualFileSystemOptions>(options =>
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<APIModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
